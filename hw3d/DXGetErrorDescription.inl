...
DWORD result = DX_FORMATMESSAGE(FORMAT_MESSAGE_FROM_SYSTEM,
                                nullptr,
                                hr,
...
switch (hr) {
  ...
  CHK_ERR(DDERR_CANNOTATTACHSURFACE,
          "This surface can not be attached to the requested surface.")
  CHK_ERR(DDERR_CANNOTDETACHSURFACE,
  ...
  CHK_ERR(DDERR_HEIGHTALIGN,
          "Height of rectangle provided is not a multiple of reqd alignment")
  CHK_ERR(DDERR_INCOMPATIBLEPRIMARY,
          "Unable to match primary surface creation request with existing "
          "primary surface.")
  CHK_ERR(DDERR_INVALIDCAPS,
          "One or more of the caps bits passed to the callback are incorrect.")
  CHK_ERR(DDERR_INVALIDCLIPLIST,
  ...
  CHK_ERR(DDERR_NOCOLORKEYHW,
          "Operation could not be carried out because there is no hardware "
          "support of the dest color key.")
  CHK_ERR(DDERR_NODIRECTDRAWSUPPORT,
          "No DirectDraw support possible with current display driver")
  CHK_ERR(DDERR_NOEXCLUSIVEMODE,
  ...
  CHK_ERR(DDERR_NORASTEROPHW,
          "Operation could not be carried out because there is no appropriate "
          "raster op hardware present or available.")
  CHK_ERR(DDERR_NOROTATIONHW,
          "Operation could not be carried out because there is no rotation "
          "hardware present or available.")
  CHK_ERR(DDERR_NOSTRETCHHW,
          "Operation could not be carried out because there is no hardware "
          "support for stretching")
  CHK_ERR(DDERR_NOT4BITCOLOR,
          "DirectDrawSurface is not in 4 bit color palette and the requested "
          "operation requires 4 bit color palette.")
  CHK_ERR(DDERR_NOT4BITCOLORINDEX,
          "DirectDrawSurface is not in 4 bit color index palette and the "
          "requested operation requires 4 bit color index palette.")
  CHK_ERR(DDERR_NOT8BITCOLOR,
          "DirectDraw Surface is not in 8 bit color mode and the requested "
          "operation requires 8 bit color.")
  CHK_ERR(DDERR_NOTEXTUREHW,
          "Operation could not be carried out because there is no texture "
          "mapping hardware present or available.")
  CHK_ERR(DDERR_NOVSYNCHW,
          "Operation could not be carried out because there is no hardware "
          "support for vertical blank synchronized operations.")
  CHK_ERR(DDERR_NOZBUFFERHW,
          "Operation could not be carried out because there is no hardware "
          "support for zbuffer blting.")
  CHK_ERR(DDERR_NOZOVERLAYHW,
          "Overlay surfaces could not be z layered based on their BltOrder "
          "because the hardware does not support z layering of overlays.")
  CHK_ERR(DDERR_OUTOFCAPS,
  ...
  CHK_ERR(DDERR_OVERLAYCOLORKEYONLYONEACTIVE,
          "Can only have ony color key active at one time for overlays")
  CHK_ERR(DDERR_PALETTEBUSY,
          "Access to this palette is being refused because the palette is "
          "already locked by another thread.")
  CHK_ERR(DDERR_COLORKEYNOTSET,
          "No src color key specified for this operation.")
  CHK_ERR(DDERR_SURFACEALREADYATTACHED,
          "This surface is already attached to the surface it is being "
          "attached to.")
  CHK_ERR(DDERR_SURFACEALREADYDEPENDENT,
          "This surface is already a dependency of the surface it is being "
          "made a dependency of.")
  CHK_ERR(DDERR_SURFACEBUSY,
          "Access to this surface is being refused because the surface is "
          "already locked by another thread.")
  CHK_ERR(
      DDERR_CANTLOCKSURFACE,
      "Access to this surface is being refused because no driver exists which "
      "can supply a pointer to the surface. This is most likely to happen when "
      "attempting to lock the primary surface when no DCI provider is present. "
      "Will also happen on attempts to lock an optimized surface.")
  CHK_ERR(DDERR_SURFACEISOBSCURED,
          "Access to Surface refused because Surface is obscured.")
  CHK_ERR(DDERR_SURFACELOST,
          "Access to this surface is being refused because the surface is "
          "gone. The DIRECTDRAWSURFACE object representing this surface should "
  ...
  CHK_ERR(DDERR_UNSUPPORTEDFORMAT,
          "Pixel format requested is unsupported by DirectDraw")
  CHK_ERR(DDERR_UNSUPPORTEDMASK,
  ...
  CHK_ERR(DDERR_XALIGN,
          "Rectangle provided was not horizontally aligned on reqd. boundary")
  CHK_ERR(DDERR_INVALIDDIRECTDRAWGUID,
          "The GUID passed to DirectDrawCreate is not a valid DirectDraw "
          "driver identifier.")
  CHK_ERR(DDERR_DIRECTDRAWALREADYCREATED,
          "A DirectDraw object representing this driver has already been "
          "created for this process.")
  CHK_ERR(DDERR_NODIRECTDRAWHW,
          "A hardware only DirectDraw object creation was attempted but the "
          "driver did not support any hardware.")
  CHK_ERR(DDERR_PRIMARYSURFACEALREADYEXISTS,
          "this process already has created a primary surface")
  CHK_ERR(DDERR_NOEMULATION, "software emulation not available.")
  CHK_ERR(DDERR_REGIONTOOSMALL,
          "region passed to Clipper::GetClipList is too small.")
  CHK_ERR(DDERR_CLIPPERISUSINGHWND,
          "an attempt was made to set a clip list for a clipper objec that is "
          "already monitoring an hwnd.")
  CHK_ERR(DDERR_NOCLIPPERATTACHED,
          "No clipper object attached to surface object")
  CHK_ERR(DDERR_NOHWND,
          "Clipper notification requires an HWND or no HWND has previously "
          "been set as the CooperativeLevel HWND.")
  CHK_ERR(DDERR_HWNDSUBCLASSED,
          "HWND used by DirectDraw CooperativeLevel has been subclassed, this "
          "prevents DirectDraw from restoring state.")
  CHK_ERR(DDERR_HWNDALREADYSET,
          "The CooperativeLevel HWND has already been set. It can not be reset "
          "while the process has surfaces or palettes created.")
  CHK_ERR(DDERR_NOPALETTEATTACHED,
          "No palette object attached to this surface.")
  CHK_ERR(DDERR_NOPALETTEHW,
          "No hardware support for 16 or 256 color palettes.")
  CHK_ERR(DDERR_BLTFASTCANTCLIP,
          "If a clipper object is attached to the source surface passed into a "
          "BltFast call.")
  CHK_ERR(DDERR_NOBLTHW, "No blter.")
  CHK_ERR(DDERR_NODDROPSHW, "No DirectDraw ROP hardware.")
  CHK_ERR(DDERR_OVERLAYNOTVISIBLE,
          "returned when GetOverlayPosition is called on a hidden overlay")
  CHK_ERR(DDERR_NOOVERLAYDEST,
          "returned when GetOverlayPosition is called on a overlay that "
          "UpdateOverlay has never been called on to establish a destionation.")
  CHK_ERR(DDERR_INVALIDPOSITION,
          "returned when the position of the overlay on the destionation is no "
          "longer legal for that destionation.")
  CHK_ERR(DDERR_NOTAOVERLAYSURFACE,
          "returned when an overlay member is called for a non-overlay surface")
  CHK_ERR(DDERR_EXCLUSIVEMODEALREADYSET,
          "An attempt was made to set the cooperative level when it was "
          "already set to exclusive.")
  CHK_ERR(DDERR_NOTFLIPPABLE,
          "An attempt has been made to flip a surface that is not flippable.")
  CHK_ERR(DDERR_CANTDUPLICATE,
          "Can't duplicate primary & 3D surfaces, or surfaces that are "
          "implicitly created.")
  CHK_ERR(DDERR_NOTLOCKED,
          "Surface was not locked.  An attempt to unlock a surface that was "
          "not locked at all, or by this process, has been attempted.")
  CHK_ERR(DDERR_CANTCREATEDC,
          "Windows can not create any more DCs, or a DC was requested for a "
          "paltte-indexed surface when the surface had no palette AND the "
          "display mode was not palette-indexed (in this case DirectDraw "
          "cannot select a proper palette into the DC)")
  CHK_ERR(DDERR_NODC, "No DC was ever created for this surface.")
  CHK_ERR(DDERR_WRONGMODE,
          "This surface can not be restored because it was created in a "
          "different mode.")
  CHK_ERR(DDERR_IMPLICITLYCREATED,
          "This surface can not be restored because it is an implicitly "
          "created surface.")
  CHK_ERR(DDERR_NOTPALETTIZED,
          "The surface being used is not a palette-based surface")
  CHK_ERR(DDERR_UNSUPPORTEDMODE,
          "The display is currently in an unsupported mode")
  CHK_ERR(DDERR_NOMIPMAPHW,
          "Operation could not be carried out because there is no mip-map "
          "texture mapping hardware present or available.")
  CHK_ERR(DDERR_INVALIDSURFACETYPE,
          "The requested action could not be performed because the surface was "
          "of the wrong type.")
  CHK_ERR(DDERR_NOOPTIMIZEHW,
          "Device does not support optimized surfaces, therefore no video "
          "memory optimized surfaces")
  CHK_ERR(DDERR_NOTLOADED,
          "Surface is an optimized surface, but has not yet been allocated any "
          "memory")
  CHK_ERR(DDERR_NOFOCUSWINDOW,
          "Attempt was made to create or set a device window without first "
          "setting the focus window")
  CHK_ERR(DDERR_NOTONMIPMAPSUBLEVEL,
          "Attempt was made to set a palette on a mipmap sublevel")
  CHK_ERR(DDERR_DCALREADYCREATED,
          "A DC has already been returned for this surface. Only one DC can be "
          "retrieved per surface.")
  CHK_ERR(DDERR_NONONLOCALVIDMEM,
          "An attempt was made to allocate non-local video memory from a "
          "device that does not support non-local video memory.")
  ...
  CHK_ERR(DDERR_NOTPAGELOCKED,
          "An attempt was made to page unlock a surface with no outstanding "
          "page locks.")
  CHK_ERR(
      DDERR_MOREDATA,
      "There is more data available than the specified buffer size could hold")
  CHK_ERR(DDERR_EXPIRED,
  ...
  CHK_ERR(DDERR_NODRIVERSUPPORT,
          "The driver does not enumerate display mode refresh rates.")
  CHK_ERR(DDERR_DEVICEDOESNTOWNSURFACE,
  ...
  //      CHK_ERR(DI_SETTINGSNOTSAVED_ACCESSDENIED,
  ...
  CHK_ERR(DIERR_INPUTLOST,
          "Access to the device has been lost.  It must be re-acquired.")
  CHK_ERR(DIERR_ACQUIRED,
  ...
  CHK_ERR(DIERR_HASEFFECTS,
          "The device cannot be reinitialized because there are still effects "
          "attached to it. & At least one of the pins involved in the "
          "operation is already connected.")
  CHK_ERR(DIERR_NOTEXCLUSIVEACQUIRED,
          "The operation cannot be performed unless the device is acquired in "
          "DISCL_EXCLUSIVE mode. & This operation cannot be performed because "
          "the filter is active.")
  CHK_ERR(DIERR_INCOMPLETEEFFECT,
          "The effect could not be downloaded because essential information is "
          "missing.  For example, no axes have been associated with the "
          "effect, or no type-specific information has been created. & One of "
          "the specified pins supports no media types.")
  ...
  CHK_ERR(DIERR_EFFECTPLAYING,
          ...
          "of an effect while it is playing. & Two pins of the same direction "
          "cannot be connected together.")
  CHK_ERR(DIERR_UNPLUGGED,
          "The operation could not be completed because the device is not "
          "plugged in. & The operation cannot be performed because the pins "
          "are not connected.")
  CHK_ERR(DIERR_REPORTFULL,
          "SendDeviceData failed because more information was requested to be "
          "sent than can be sent to the device.  Some devices have "
          "restrictions on how much data can be sent to them.  (For example, "
          "there might be a limit on the number of buttons that can be pressed "
          "at once.) & No sample buffer allocator is available.")
  CHK_ERR(DIERR_MAPFILEFAIL,
  ...
  CHK_ERR(DIERR_CANCELLED,
          "The user cancelled the install operation. & The stream already has "
          "allocated samples and the surface doesn't match the sample format.")
  CHK_ERR(
      DIERR_BADINF,
      "The INF file for the selected device could not be found or is invalid "
      "or is damaged. & The specified purpose ID can't be used for the call.")
  ...
  CHK_ERR(D3DERR_PRESENT_STATISTICS_DISJOINT,
  ...
  // d3d10.h error codes
  // -------------------------------------------------------------
  CHK_ERR(D3D10_ERROR_TOO_MANY_UNIQUE_STATE_OBJECTS,
  ...
  // dxgi.h error codes
  // -------------------------------------------------------------
  CHK_ERR(DXGI_STATUS_OCCLUDED,
          "The target window or output has been occluded. The application "
          "should suspend rendering operations if possible.")
  ...
  CHK_ERR(DXGI_ERROR_INVALID_CALL,
          "The application has made an erroneous API call that it had enough "
          "information to avoid. This error is intended to denote that the "
          "application should be altered to avoid the error. Use of the debug "
          "version of the DXGI.DLL will provide run-time debug output with "
          "further information.")
  CHK_ERR(DXGI_ERROR_NOT_FOUND,
          "The item requested was not found. For GetPrivateData calls, this "
          "means that the specified GUID had not been previously associated "
          "with the object.")
  CHK_ERR(DXGI_ERROR_MORE_DATA,
          "The specified size of the destination buffer is too small to hold "
          "the requested data.")
  ...
  CHK_ERR(DXGI_ERROR_DEVICE_RESET,
          "Device reset due to a badly formed commant.")
  CHK_ERR(DXGI_ERROR_WAS_STILL_DRAWING, "Was still drawing.")
  CHK_ERR(DXGI_ERROR_FRAME_STATISTICS_DISJOINT,
          "The requested functionality is not supported by the device or the "
          "driver.")
  CHK_ERR(DXGI_ERROR_GRAPHICS_VIDPN_SOURCE_IN_USE,
          "The requested functionality is not supported by the device or the "
          "driver.")
  CHK_ERR(DXGI_ERROR_DRIVER_INTERNAL_ERROR,
          "An internal driver error occurred.")
  CHK_ERR(DXGI_ERROR_NONEXCLUSIVE,
          "The application attempted to perform an operation on an DXGI output "
          "that is only legal after the output has been claimed for exclusive "
          "owenership.")
  CHK_ERR(DXGI_ERROR_NOT_CURRENTLY_AVAILABLE,
          "The requested functionality is not supported by the device or the "
          "driver.")
  CHK_ERR(DXGI_ERROR_REMOTE_CLIENT_DISCONNECTED,
          "Remote desktop client disconnected.")
  CHK_ERR(DXGI_ERROR_REMOTE_OUTOFMEMORY,
          "Remote desktop client is out of memory.")

  // -------------------------------------------------------------
  // d3d11.h error codes
  // -------------------------------------------------------------
  CHK_ERR(D3D11_ERROR_TOO_MANY_UNIQUE_STATE_OBJECTS,
          "There are too many unique state objects.")
  CHK_ERR(D3D11_ERROR_FILE_NOT_FOUND, "File not found")
  CHK_ERR(D3D11_ERROR_TOO_MANY_UNIQUE_VIEW_OBJECTS,
          "Therea are too many unique view objects.")
  CHK_ERR(D3D11_ERROR_DEFERRED_CONTEXT_MAP_WITHOUT_INITIAL_DISCARD,
  ...
  // -------------------------------------------------------------
  //        CHK_ERR(D2DERR_UNSUPPORTED_PIXEL_FORMAT, "The pixel format is not
  //        supported.") CHK_ERR(D2DERR_INSUFFICIENT_BUFFER, "The supplied
  //        buffer was too small to accomodate the data.")
  CHK_ERR(D2DERR_WRONG_STATE,
          "The object was not in the correct state to process the method.")
  CHK_ERR(D2DERR_NOT_INITIALIZED, "The object has not yet been initialized.")
  CHK_ERR(D2DERR_UNSUPPORTED_OPERATION,
          "The requested opertion is not supported.")
  CHK_ERR(D2DERR_SCANNER_FAILED,
          "The geomery scanner failed to process the data.")
  CHK_ERR(D2DERR_SCREEN_ACCESS_DENIED, "D2D could not access the screen.")
  CHK_ERR(D2DERR_DISPLAY_STATE_INVALID,
          "A valid display state could not be determined.")
  CHK_ERR(D2DERR_ZERO_VECTOR, "The supplied vector is zero.")
  CHK_ERR(D2DERR_INTERNAL_ERROR,
          "An internal error (D2D bug) occurred. On checked builds, we would "
          "assert.")
  CHK_ERR(D2DERR_DISPLAY_FORMAT_NOT_SUPPORTED,
          "The display format we need to render is not supported by the "
          "hardware device.")
  CHK_ERR(D2DERR_INVALID_CALL, "A call to this method is invalid.")
  CHK_ERR(D2DERR_NO_HARDWARE_DEVICE,
          "No HW rendering device is available for this operation.")
  CHK_ERR(
      D2DERR_RECREATE_TARGET,
      "here has been a presentation error that may be recoverable. The caller "
      "needs to recreate, rerender the entire frame, and reattempt present.")
  CHK_ERR(D2DERR_TOO_MANY_SHADER_ELEMENTS,
          "Shader construction failed because it was too complex.")
  CHK_ERR(D2DERR_SHADER_COMPILE_FAILED, "Shader compilation failed.")
  CHK_ERR(D2DERR_MAX_TEXTURE_SIZE_EXCEEDED,
          "Requested DX surface size exceeded maximum texture size.")
  CHK_ERR(D2DERR_UNSUPPORTED_VERSION,
          "The requested D2D version is not supported.")
  CHK_ERR(D2DERR_BAD_NUMBER, "Invalid number.")
  CHK_ERR(
      D2DERR_WRONG_FACTORY,
      "Objects used together must be created from the same factory instance.")
  CHK_ERR(D2DERR_LAYER_ALREADY_IN_USE,
          "A layer resource can only be in use once at any point in time.")
  CHK_ERR(D2DERR_POP_CALL_DID_NOT_MATCH_PUSH,
          "The pop call did not match the corresponding push call")
  //        CHK_ERR(D2DERR_WRONG_RESOURCE_DOMAIN, "The resource was realized on
  //        the wrong render target")
  CHK_ERR(D2DERR_PUSH_POP_UNBALANCED, "The push and pop calls were unbalanced")
  CHK_ERR(D2DERR_RENDER_TARGET_HAS_LAYER_OR_CLIPRECT,
          "Attempt to copy from a render target while a layer or clip rect is "
          "applied")
  CHK_ERR(D2DERR_INCOMPATIBLE_BRUSH_TYPES,
          "The brush types are incompatible for the call.")
  CHK_ERR(D2DERR_WIN32_ERROR, "An unknown win32 failure occurred.")
  CHK_ERR(D2DERR_TARGET_NOT_GDI_COMPATIBLE,
          "The render target is not compatible with GDI")
  CHK_ERR(D2DERR_TEXT_EFFECT_IS_WRONG_TYPE,
          "A text client drawing effect object is of the wrong type")
  CHK_ERR(D2DERR_TEXT_RENDERER_NOT_RELEASED,
          "The application is holding a reference to the IDWriteTextRenderer "
          "interface after the corresponding DrawText or DrawTextLayout call "
          "has returned. The IDWriteTextRenderer instance will be zombied.")
  //        CHK_ERR(D2DERR_EXCEEDS_MAX_BITMAP_SIZE, "The requested size is
  //        larger than the guaranteed supported texture size.")

  // -------------------------------------------------------------
  // DirectWrite error codes
  // -------------------------------------------------------------
  CHK_ERR(DWRITE_E_FILEFORMAT,
          "Indicates an error in an input file such as a font file.")
  CHK_ERR(DWRITE_E_UNEXPECTED,
          "Indicates an error originating in DirectWrite code, which is not "
          "expected to occur but is safe to recover from.")
  CHK_ERR(DWRITE_E_NOFONT, "Indicates the specified font does not exist.")
  CHK_ERR(DWRITE_E_FILENOTFOUND,
          "A font file could not be opened because the file, directory, "
          "network location, drive, or other storage location does not exist "
          "or is unavailable.")
  CHK_ERR(DWRITE_E_FILEACCESS,
          "A font file exists but could not be opened due to access denied, "
          "sharing violation, or similar error.")
  CHK_ERR(DWRITE_E_FONTCOLLECTIONOBSOLETE,
          "A font collection is obsolete due to changes in the system.")
  CHK_ERR(DWRITE_E_ALREADYREGISTERED,
  ...
  CHK_ERR(WINCODEC_ERR_UNKNOWNIMAGEFORMAT,
          "Encountered unexpected value or setting in WIC image format.")
  CHK_ERR(WINCODEC_ERR_UNSUPPORTEDVERSION,
  ...
  CHK_ERR(WINCODEC_ERR_PALETTEUNAVAILABLE,
          "Required palette data not available.")
  CHK_ERR(WINCODEC_ERR_CODECTOOMANYSCANLINES,
  ...
  CHK_ERR(WINCODEC_ERR_FRAMEMISSING,
          "Expected bitmap frame data not found in WIC image.")
  CHK_ERR(WINCODEC_ERR_BADMETADATAHEADER,
  ...
  CHK_ERR(WINCODEC_ERR_UNSUPPORTEDPIXELFORMAT,
          "The pixel format is not supported.")
  CHK_ERR(WINCODEC_ERR_UNSUPPORTEDOPERATION,
          "This operation is not supported by WIC.")
  CHK_ERR(WINCODEC_ERR_INVALIDREGISTRATION,
          "Error occurred reading WIC codec registry keys.")
  CHK_ERR(WINCODEC_ERR_COMPONENTINITIALIZEFAILURE,
          "Failed initializing WIC codec.")
  CHK_ERR(WINCODEC_ERR_INSUFFICIENTBUFFER,
          "Not enough buffer space available for WIC operation.")
  CHK_ERR(WINCODEC_ERR_DUPLICATEMETADATAPRESENT,
          "Duplicate metadata detected in WIC image.")
  CHK_ERR(WINCODEC_ERR_PROPERTYUNEXPECTEDTYPE,
  ...
  CHK_ERR(WINCODEC_ERR_UNEXPECTEDMETADATATYPE,
          "Unexpected metadata type encountered in WIC image.")
  CHK_ERR(WINCODEC_ERR_REQUESTONLYVALIDATMETADATAROOT,
          "Operation only valid on meatadata root.")
  CHK_ERR(WINCODEC_ERR_INVALIDQUERYCHARACTER,
          "Invalid character in WIC metadata query.")
  CHK_ERR(WINCODEC_ERR_WIN32ERROR,
          "General Win32 error encountered during WIC operation.")
  CHK_ERR(WINCODEC_ERR_INVALIDPROGRESSIVELEVEL,
